          ...
          {profileImage ? (
            ...
            <View
              style={[
                ...
                { backgroundColor: roleColors[employeeRole] + '20' },
              ]}
            >
              <Feather
          ...
          <View style={styles.detailsRow}>
            ...
            {hasAccountAccess && (
              <View style={styles.accountBadge}>
                ...
                <ThemedText type="small" style={{ color: Colors.light.primary, marginLeft: 2 }}>
                  Account
                </ThemedText>
              </View>
            )}
            ...
            <KeyboardAwareScrollViewCompat showsVerticalScrollIndicator={false}>
              <View style={styles.editForm}>
                ...
                <Button
                  ...
                  style={{ marginTop: Spacing.sm, backgroundColor: Colors.light.error }}
                >
                  Cancel
                </Button>
              </View>
